...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarsExample02">
    ...
    <div class="container" style="margin-top: 2%; background-color: rgb(255, 255, 255);">
        ...
        <br>
        <div>
            <h5 style="text-align:center">Thêm khu vực mới</h5>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = insertZone($name, $priceHour, $keyboard, $mouse, $Monitor, $cpu, $ram, $card, $chair);
    if ($result === TRUE)
    {
...
<script>
    function fillValue(name, price,keyboard,mouse,Monitor,cpu,ram,card,chair)
    {
        $('#name').val(name);
    ...
    {
        fillValue("Name " + id, 50000,"Keyboard TEST", "Mouse TEST", "Monitor TEST", "CPU TEST", "RAM TEST", "Card TEST", "Chair TEST");
    }
</script>