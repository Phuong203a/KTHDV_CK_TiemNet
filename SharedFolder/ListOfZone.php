...
<table class="table" style="margin-top: 6%;">
        <thead>
            <tr>
                ...
                <th scope="col">Bàn phím</th>
                <th scope="col">Chuột</th>
                <th scope="col">CPU</th>
                <th scope="col">RAM</th>
                <th scope="col">VGA</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a class="btn btn-primary" href="ListOfPcs.php?name=<?php echo $row['name']; ?>">Chi Tiết</a></td>
