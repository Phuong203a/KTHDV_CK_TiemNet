...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `user` (`Id_role`, `name`, `email`, `username`, `Password`, `birthday`, `phone`, `address`) 
            VALUES (3, :name, :email, :username, :password, :birthday, :phone, :address)";
    ...
    if ($stmt->execute()) {
        ...
        echo 'window.location.href = "ListStaffAccount.php";</script>';
    } else {
